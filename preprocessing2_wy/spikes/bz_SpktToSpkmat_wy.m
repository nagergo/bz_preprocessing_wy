function [spikemat] = bz_SpktToSpkmat_wy(spikes, varargin)
...
spikemat.basepath = spikes.basepath;
spikemat.data = spkmat;
spikemat.timestamps = t;
spikemat.dt = dt;
spikemat.binsize = binsize;
spikemat.UID = spikes.UID;
if isfield(spikes,'channelID')
    spikemat.channelID = spikes.channelID;
end
